...
||(%_IsJSWeakSet(k))){
l=new SetMirror(k);
}else if((%_ClassOf(k)==='Map Iterator')
||(%_ClassOf(k)==='Set Iterator')
){
...
l.source=function(R){
if(!(%IsFunction(R)))throw %make_type_error(46);
...
if(!(%IsFunction(S)))throw %make_type_error(46);
...
if(!(%IsFunction(R)))throw %make_error(46);
...
throw %make_type_error(24,typeof s);
}
...
throw %make_type_error(88,q);
}
var u=%_Call(t,q);
if(!(%_IsJSReceiver(u))){
throw %make_type_error(81,u);
}
return u;
}
...
c.resolvePromise=function resolvePromise(v,w){
%_ResolvePromise(v,w);
}
c.rejectPromise=function rejectPromise(v,x){
%_RejectPromise(v,x,true);
}
...
if(ae>9007199254740991-ad)throw %make_type_error(255,ae,ad);
for(var w=0;w<ae;w++){
o[w+ad]=arguments[w];
}
var af=ad+ae;
...
if(%object_is_sealed(o))throw %make_type_error(14);
var ap=o[0];
...
var av=ArraySpeciesCreate(o,h(au-N,0));
if(au<N)return av;
if(UseSparseVariant(o,P,(%_IsArray(o)),au-N)){
%NormalizeElements(o);
if((%_IsArray(av)))%NormalizeElements(av);
SparseSlice(o,N,au-N,P,av);
}else{
SimpleSlice(o,N,au-N,P,av);
}
av.length=au-N;
return av;
}
...
function ComputeSpliceDeleteCount(aw,ar,P,N){
var O=0;
if(ar==1)
return P-N;
O=(%_ToInteger(aw));
...
function ArraySpliceFallback(as,aw){
var ar=arguments.length;
var o=(%_ToObject(this));
var P=(%_ToLength(o.length));
var N=ComputeSpliceStartIndex((%_ToInteger(as)),P);
var O=ComputeSpliceDeleteCount(aw,ar,P,
N);
var Q=ArraySpeciesCreate(o,O);
Q.length=O;
var ax=ar>2?ar-2:0;
if(O!=ax&&%object_is_sealed(o)){
...
if(UseSparseVariant(o,P,(%_IsArray(o)),ay)){
%NormalizeElements(o);
if((%_IsArray(Q)))%NormalizeElements(Q);
SparseSlice(o,N,O,P,Q);
SparseMove(o,N,O,P,ax);
}else{
SimpleSlice(o,N,O,P,Q);
SimpleMove(o,N,O,P,ax);
}
var w=N;
var az=2;
...
function InnerArraySort(o,p,aB){
if(!(typeof(aB)==='function')){
aB=function(M,aC){
if(M===aC)return 0;
if(%_IsSmi(M)&&%_IsSmi(aC)){
return %SmiLexicographicCompare(M,aC);
}
M=(%_ToString(M));
aC=(%_ToString(aC));
if(M==aC)return 0;
else return M<aC?-1:1;
};
}
function InsertionSort(r,n,aD){
for(var w=n+1;w<aD;w++){
var aE=r[w];
...
function GetThirdIndex(r,n,aD){
var aH=new g();
var aI=200+((aD-n)&15);
var ai=0;
n+=1;
aD-=1;
for(var w=n;w<aD;w+=aI){
aH[ai]=[w,r[w]];
ai++;
}
aH.sort(function(r,s){
return aB(r[1],s[1]);
});
var aJ=aH[aH.length>>1][0];
return aJ;
}
function QuickSort(r,n,aD){
var aJ=0;
while(true){
if(aD-n<=10){
InsertionSort(r,n,aD);
return;
}
if(aD-n>1000){
aJ=GetThirdIndex(r,n,aD);
}else{
aJ=n+((aD-n)>>1);
}
var aK=r[n];
...
r[aJ]=r[aR];
r[aR]=aQ;
partition:for(var w=aR+1;w<aS;w++){
var aE=r[w];
var aG=aB(aE,aQ);
if(aG<0){
r[w]=r[aR];
...
function CopyFromPrototype(aU,p){
var aV=0;
...
function ShadowPrototypeElements(aU,n,aD){
for(var aW=%object_get_prototype_of(aU);aW;
aW=%object_get_prototype_of(aW)){
var t=(%_IsJSProxy(aW))
?aD:%GetArrayKeys(aW,aD);
if((typeof(t)==='number')){
var aX=t;
for(var w=n;w<aX;w++){
if((%_Call(j,aW,w))){
...
for(w=p-ba;w<p;w++){
if(w in %object_get_prototype_of(aU)){
aU[w]=(void 0);
}else{
delete aU[w];
}
...
var bb;
if(!D){
bb=CopyFromPrototype(o,p);
}
var bc=%RemoveArrayHoles(o,p);
if(bc==-1){
bc=SafeRemoveArrayHoles(o);
}
QuickSort(o,0,bc);
if(!D&&(bc+1<bb)){
ShadowPrototypeElements(o,bc,bb);
}
return o;
}
%DefineMethodsInternal(f.prototype,class{sort(aB){
if(!(aB===(void 0))&&!(typeof(aB)==='function')){
throw %make_type_error(17,aB);
}
var o=(%_ToObject(this));
var p=(%_ToLength(o.length));
return InnerArraySort(o,p,aB);
}},-1);
%DefineMethodsInternal(f.prototype,class{lastIndexOf(aE,X){
var o=(%_ToObject(this));
...
%ToFastProperties(bi);
%AddNamedProperty(f.prototype,m,bi,
2|1);
var bj=f.prototype.indexOf;
var aa=f.prototype.join;
var bk=f.prototype.pop;
var bl=f.prototype.push;
var bm=f.prototype.slice;
var bn=f.prototype.shift;
var bo=f.prototype.sort;
var bp=f.prototype.splice;
var bq=f.prototype.toString;
var br=f.prototype.unshift;
var bs=f.prototype.entries;
var bt=f.prototype.forEach;
var bu=f.prototype.keys;
var bv=f.prototype[l];
...
%InstallToContext([
"array_entries_iterator",bs,
"array_for_each_iterator",bt,
"array_keys_iterator",bu,
"array_values_iterator",bv,
...
var k=a.Math.min;
var l=b.ImportNow("iterator_symbol");
var m=b.ImportNow("species_symbol");
var n=a.Uint8Array;
...
f=x.InnerArrayJoin;
g=x.InnerArraySort;
h=x.InnerArrayToLocaleString;
});
function SpeciesConstructor(y,z){
var A=y.constructor;
if((A===(void 0))){
return z;
}
...
throw %make_type_error(267);
}
function ValidateTypedArray(C,D){
if(!(%_IsTypedArray(C))
)throw %make_type_error(91);
if(%_ArrayBufferViewWasNeutered(C))
throw %make_type_error(49,D);
}
function TypedArrayDefaultConstructor(E){
switch(%_ClassOf(E)){
case"Uint8Array":
return n;
...
function TypedArrayCreate(A,F,G,H){
if((G===(void 0))){
var I=new A(F);
}else{
var I=new A(F,G,H);
}
ValidateTypedArray(I,"TypedArrayCreate");
if((typeof(F)==='number')&&%_TypedArrayGetLength(I)<F){
throw %make_type_error(283);
}
return I;
}
function TypedArraySpeciesCreate(J,F,G,H){
var z=TypedArrayDefaultConstructor(J);
var A=SpeciesConstructor(J,z);
return TypedArrayCreate(A,F,G,H);
}
function InnerTypedArrayFilter(K,L,C,M,N){
var O=0;
for(var P=0;P<M;P++){
if(P in C){
var Q=C[P];
if(%_Call(K,L,Q,P,C)){
%CreateDataProperty(N,O,Q);
O++;
}
}
}
...
%DefineMethodsInternal(w.prototype,class{filter(K,thisArg){
ValidateTypedArray(this,"%TypeArray%.prototype.filter");
var M=%_TypedArrayGetLength(this);
if(!(typeof(K)==='function'))throw %make_type_error(24,K);
var N=new i();
InnerTypedArrayFilter(K,thisArg,this,M,N);
var R=N.length;
var S=TypedArraySpeciesCreate(this,R);
for(var P=0;P<R;P++){
S[P]=N[P];
}
return S;
}},1);
%DefineMethodsInternal(w.prototype,class{sort(comparefn){
ValidateTypedArray(this,"%TypedArray%.prototype.sort");
if(!(comparefn===(void 0))&&!(typeof(comparefn)==='function')){
throw %make_type_error(17,comparefn);
}
var M=%_TypedArrayGetLength(this);
if((comparefn===(void 0))){
return %TypedArraySortFast(this);
}
return g(this,M,comparefn);
}},-1);
%DefineMethodsInternal(w.prototype,class{toLocaleString(){
ValidateTypedArray(this,"%TypedArray%.prototype.toLocaleString");
var M=%_TypedArrayGetLength(this);
return h(this,M);
}},-1);
%DefineMethodsInternal(w.prototype,class{join(separator){
ValidateTypedArray(this,"%TypedArray%.prototype.join");
var M=%_TypedArrayGetLength(this);
return f(separator,this,M);
}},-1);
function IterableToArrayLike(T){
var U=e(T,l);
if(!(U===(void 0))){
var V=new i();
var P=0;
...
var C=[];
%MoveArrayContents(V,C);
return C;
}
return(%_ToObject(T));
}
%DefineMethodsInternal(w,class{'from'(source,mapfn,thisArg){
if(!%IsConstructor(this))throw %make_type_error(83,this);
var X;
if(!(mapfn===(void 0))){
if(!(typeof(mapfn)==='function'))throw %make_type_error(24,this);
X=true;
}else{
X=false;
}
var Y=IterableToArrayLike(source);
var M=(%_ToLength(Y.length));
var Z=TypedArrayCreate(this,M);
var W,aa;
for(var P=0;P<M;P++){
W=Y[P];
if(X){
aa=%_Call(mapfn,thisArg,W,P);
}else{
aa=W;
}
Z[P]=aa;
...
throw %make_type_error(35,"TypedArray");
}
...
throw %make_range_error(203,ah,ab,ad);
}
return ah;
}
return ag;
...
if((aE===null))throw %make_range_error(171,aD);
...
throw %make_type_error(39,"PluralRules");
}
var B=arguments[0];
var C=arguments[1];
if((C===(void 0))){
...
throw %make_range_error(178,bs);
}
if(bh.style==='currency'&&(bs===(void 0))){
throw %make_type_error(41);
}
var bC,bD;
var bE=ac(
...
if((%IS_VAR(this)===null)||(this===(void 0)))throw %make_type_error(26,"Intl.DateTimeFormat.prototype.formatToParts");
if(!(typeof(this)==='object')
){
throw %make_type_error(25,this);
}
...
if((aE===null))throw %make_range_error(170,bZ);
...
toLocaleLowerCase(B){
if((%IS_VAR(this)===null)||(this===(void 0)))throw %make_type_error(26,"String.prototype.toLocaleLowerCase");
return LocaleConvertCase((%_ToString(this)),B,false);
}
toLocaleUpperCase(B){
if((%IS_VAR(this)===null)||(this===(void 0)))throw %make_type_error(26,"String.prototype.toLocaleUpperCase");
...
throw %make_type_error(71,"Number");
}
var B=arguments[0];
var C=arguments[1];
